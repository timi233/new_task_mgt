<template>
  <DesktopCustomerCreate
    v-if="isDesktop"
    :customer-id="customerId"
    :channels="channelList"
    :on-submit="handleSubmit"
    :on-back="handleBack"
    :on-fetch-customer="fetchCustomerData"
  />
  <div v-else class="customer-create-page">
...
import DesktopCustomerCreate from './DesktopCustomerCreate.vue';
