...
export const statisticsApi = {
  ...
  orderStatus: () => api.get('/statistics/order-status'),
  orderType: () => api.get('/statistics/order-type'),
  technicianWorkload: (params?: any) => api.get('/statistics/technician-workload', { params }),
  problemTypes: () => api.get('/statistics/problem-types'),
  evaluation: () => api.get('/statistics/evaluation'),
  trend: (days?: number) => api.get('/statistics/trend', { params: { days } }),
};
