...
async function getApprovalDefinition() {
    try {
        ...
        console.log('');
        // 调用飞书API获取审批定义详情
        const response = await axios_1.default.get(`https://open.feishu.cn/open-apis/approval/v4/approvals/${APPROVAL_CODE}`, {
            headers: {
...
//# sourceMappingURL=getApprovalDefinition.js.map